...
export default async function PersonalizedPage({ searchParams }: { searchParams: Promise<{ produto?: string }> }) {
  ...
  return <><SiteHeader /><main className="service-page">
    <section className="service-hero"><span className="eyebrow">Projetos personalizados</span><h1>Tem uma ideia?<br />Vamos transformar em algo que possa existir.</h1><p>Descreva a necessidade, a referência ou o produto que você gostaria de adaptar. Antes de produzir, avaliamos viabilidade, medidas, uso e material.</p></section>
    ...
    <section className="service-process"><div><span className="eyebrow">Como funciona</span><h2>Da referência à produção.</h2></div><ol><li><strong>01</strong><span>Você descreve a ideia e o contexto de uso.</span></li><li><strong>02</strong><span>A Alvora Lab avalia a viabilidade.</span></li><li><strong>03</strong><span>Detalhes e orçamento são alinhados.</span></li><li><strong>04</strong><span>A produção começa após aprovação.</span></li></ol></section>
    <section className="quote-section" id="orcamento"><div className="quote-section__intro"><span className="eyebrow">Formulário de orçamento</span><h2>Conte o que você quer criar.</h2><p>Inclua uso, quantidade, medidas aproximadas e uma referência, se tiver. Esses detalhes ajudam na avaliação da peça.</p></div><QuoteForm initialProduct={produto} /></section>
  </main><SiteFooter /></>;
}
