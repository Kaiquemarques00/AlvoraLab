  ...
  return <>
    ...
    <main>
      ...
      <section className="journey-section" aria-labelledby="journey-title">
        ...
        <div className="journey-section__heading"><h2 id="journey-title">Você pode encontrar uma peça pronta ou começar algo do zero.</h2><p>Dois caminhos simples, sem misturar compra de catálogo com solicitação de projeto.</p></div>
        <div className="journey-grid">
          ...
          <Link href="/personalizados" className="journey-card journey-card--accent"><span>02</span><div><h3>Projetos personalizados</h3><p>Envie sua ideia, referência ou necessidade. A viabilidade é avaliada antes de qualquer produção.</p></div><ArrowIcon diagonal /></Link>
        </div>
      </section>
      ...
      <ProductCarousel products={products.filter((product) => product.featured)} />

      <section className="use-section" aria-labelledby="use-title">
        <div className="use-section__media"><img src="/images/cable-organizer.png" alt="Produto de impressão 3D aplicado a organização" /></div>
      ...
      <section className="custom-section" id="personalizados" aria-labelledby="custom-title">
        <div className="custom-section__intro"><span className="eyebrow">Personalizados</span><h2 id="custom-title">Tem uma ideia?<br />Vamos avaliar como ela pode ganhar forma.</h2><p>Você envia a necessidade ou referência. A Alvora Lab avalia geometria, uso, medidas, material e viabilidade antes de seguir.</p><Link className="button button--light" href="/personalizados#orcamento">Solicitar projeto <ArrowIcon /></Link></div>
        <ol className="process-list"><li><span>01</span><div><strong>Envie sua ideia</strong><p>Explique o que precisa e compartilhe referências.</p></div></li><li><span>02</span><div><strong>Avaliamos</strong><p>Verificamos viabilidade, aplicação e detalhes necessários.</p></div></li><li><span>03</span><div><strong>Definimos</strong><p>Alinhamos características e orçamento antes da produção.</p></div></li><li><span>04</span><div><strong>Produzimos</strong><p>A peça segue para fabricação após aprovação.</p></div></li></ol>
      </section>
      ...
      <section className="about-section" id="sobre" aria-labelledby="about-title"><div className="about-section__product-ghost" aria-hidden="true"><img src="/images/hero-product.png" alt="" /></div><div className="about-section__heading"><span className="eyebrow">Alvora Lab</span><h2 id="about-title">Uma pequena fábrica digital para ideias úteis.</h2><p>A Alvora Lab nasce na interseção entre fabricação, experimentação e produto.</p></div><div className="about-section__body"><p>Nosso objetivo é transformar necessidades e referências em objetos físicos que façam sentido no uso real — seja uma peça pronta do catálogo, uma personalização ou uma solução para um negócio.</p><p>O site existe para mostrar o que já está disponível e abrir um caminho claro para o que ainda precisa ser criado.</p><Link href="/sobre" className="text-link">Conheça a Alvora Lab <ArrowIcon /></Link></div></section>
