...
export default function BusinessPage() {
  return <><SiteHeader /><main className="service-page">
    ...
    <section className="quote-section" id="orcamento"><div className="quote-section__intro"><span className="eyebrow">Orçamento B2B</span><h2>Explique a necessidade do seu negócio.</h2><p>Informe quantidade, finalidade, prazo e referências. A solicitação será avaliada antes de qualquer compromisso de produção.</p></div><QuoteForm business /></section>
  </main><SiteFooter /></>;
}
